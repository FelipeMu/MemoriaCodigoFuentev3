...
sgl = StructPredTecs_NNM2d5OI_FD_LR0d001_E300_DO0d2(15).VSCd_OriginalSignal;
w = 'amor'; 
min_error_amor_bump(sgl, w)
min_error_morse(sgl)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i = 1:num_healthy_people
    ...
    struct_lds_sano(i).name_file = erase(filename_sano, '.PAR'); %(nombre del individuo)

    if temp == 1
        struct_lds_sano(i).signal_pam = columnas_sano(:, 2); % PAM es la columna 2 para 27_HC036101
        struct_lds_sano(i).signal_vscd = columnas_sano(:, 1); % VSCd es la columna 1 27_HC036101
        struct_lds_sano(i).signal_vsci = columnas_sano(:, 3); % VSCi es la tercera columna para 27_HC036101
        temp = 0;
    else
...
apply_noise_and_filter_lds(struct_lds_sano, struct_lds_tec, fs, num_of_noises_signals);
