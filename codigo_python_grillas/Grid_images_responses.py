...
# crear grilla grupo:
grupo = "TEC" # elegir: SANOS o TEC
base_dir = os.path.join(r"D:\TT\Memoria\CodigoFuente\Graphics_Responses_Norm_NNM2d5OI_FD_LR0d001_E300_DO0d2", f"GraphicResponseVSC_NormMinMax_NNM2d5OI_FD_LR0d001_E300_DO0d2_{grupo}")
output_dir = os.path.join(r"D:\TT\Memoria\CodigoFuente\Graphics_Responses_Norm_NNM2d5OI_FD_LR0d001_E300_DO0d2", f"PACK6_{grupo}")

# Procesar las carpetas signals_VSCd y signals_VSCi
create_image_packs(base_dir, output_dir, "responses_VSCd", "pack6_responseVSCd")
create_image_packs(base_dir, output_dir, "responses_VSCi", "pack6_responseVSCi")
